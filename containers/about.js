...
const About = () => (
    <section id="about" className="about-section background-color-gray-light-1 text-color-black light padding-top-r2 padding-bottom-r2">
        <div className="container">
            <div className="row">
            <div className="col-xs-12 col-sm-6 col-md-7">
               <Card className="padding-3">
                    <Text tag="h2" cssClass="h1 nospacing padding-bottom-1">Who am I?</Text>
                    ...
                    <Button href="#" className="button button--primary" download>Download resume</Button>
                </Card>
            </div>

            <div className="col-xs-12 col-sm-6 col-md-5">
                <Card className="padding-3">
                    <Text tag="h2" cssClass="h1 nospacing padding-bottom-1">Personal Information</Text>
